...
export default class AddIndustryType extends Component {
  ...
  onNext = async () => {
    ...
    let validatePhoto = inputEmptyValidate(this.state.adminPhoto);
    ...
    if (errorCount === 0) {
      ...
      //   consoleLog("resData::",objData)

      let res = await ApiCall("createIndustryType", objData);
      ...
      if (
        ...
        toast.success(
          AlertMessage.MESSAGE.INDUSTRY_TYPE.ADDED_SUCCESSFULLY,
          {
            hideProgressBar: true,
          }
        );
        ...
        if (
          ...
          toast.error(AlertMessage.MESSAGE.INDUSTRY_TYPE.INDUSTRY_TYPE_EXIST, {
            hideProgressBar: true,
          });
        } else {
      ...
      <React.Fragment>
        ...
        <div className="component-wrapper" hidden={this.state.isLoad}>
          ...
          >
            ...
            <Link to="/adminIndustryTypeList">Industry Type</Link> / Add
          </div>
          <h3 className="dcs">Add New Industry Type</h3>
