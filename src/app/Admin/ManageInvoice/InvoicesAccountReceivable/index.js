...
const bulkStyles = {
  ...
  option: (styles, { data, isDisabled, isFocused, isSelected }) => {
    ...
    return {
      ...styles,
      // fontColor:"#FFFFFF",
      color: isFocused ? "blue" : "#01A0DF",
      //   backgroundColor: isDisabled ? "red" : "white",
      // color: "#FFFFFF",
      color: isSelected ? "white" : "#01A0DF",
      cursor: isDisabled ? "not-allowed" : "default",
    };
  },
};
...
export default class InvoicesReceivable extends React.Component {
  constructor(props) {
    super(props);
    var today = new Date();
    ...
    return (
      <React.Fragment>
        ...
        <div class="component-wrapper vewaljobs invoc_pge">
          ...
          >
            <Link to="/adminDashboard">Dashboard</Link> / Accounts / Receivables
          </div>
