...
import { DraftsRounded, ThumbDown } from "@material-ui/icons";
...
export default class AddClientContact extends Component {
  constructor(props) {
    super(props);
    // consoleLog("Params : ", this.props.match.path);
    this.state = {
      page: true,
      showPage: false,
  ...
  componentDidMount() {
    ...
    // consoleLog("param::", window.clientId);
    // consoleLog("type of param::", typeof window.clientId);
  ...
  load = async () => {
    ...
    // consoleLog("client main id::", this.state.clientId);
    ...
    if (
      ...
      console.log("pre client id::::::::::", this.state.clientId);
      console.log("type pre client id::::::::::", typeof this.state.clientId);
      for (let i = 0; i < clientResData.length; i++) {
        console.log("client id::::::::::", typeof clientResData[i].clientid);
        clientDataArr.push({
          label: clientResData[i].clientName,
          value: clientResData[i].clientid,
        });

        if (clientResData[i].clientid == this.state.clientId) {
          clientDataObj = {
            label: clientResData[i].clientName,
            value: clientResData[i].clientid,
          };
  ...
  onNext = async () => {
    ...
    // consoleLog("$$$$$$phone", validatePhone);
      ...
      if (this.state.roleData.label === "LEI") {
        ...
        let leiData = {
          ...
          dob:
            this.state.dobDate == ""
              ? ""
              : SetDatabaseDateFormat(this.state.dobDate),
        ...
        let reslei = await ApiCall("addclientcontacttypeleiV2", leiData);
  ...
  onAddressNext = async () => {
    ...
    if (errorCount === 0) {
      ...
      if (this.state.roleData.label === "Requester") {
        // consoleLog("amount::", typeof this.state.amount);
        let objData = {
          // ..............................
          fname: this.state.fname,
          lname: this.state.lname,
                        ...
                        <div className="col-md-5">
                          <div className="form_rbx">
                            ...
                            <Select
                              ...
                              // isDisabled = {this.state.pathCheck == true ? true : false}
                            />
                          </div>
                        </div>
                      </div>
