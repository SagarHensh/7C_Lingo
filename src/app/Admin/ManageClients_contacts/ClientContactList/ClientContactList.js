...
export default class ClientContactList extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      selectedStatus: { label: "Select", value: "" },
      departmentData: {
        label: "Select",
        value: "",
      },
  ...
  listApi = async (data) => {
    ...
    if (
      ...
      console.log("Contact Payload data>>>", decodeData);
  ...
  onChangeLimit = (dat) => {
    ...
    let fetchData = {
      limit: dat.value,
      // offset: JSON.stringify((this.state.current_page - 1) * dat.value),
      offset: "0",
      clientcontactname: this.state.name,
      email: this.state.email,
      mobile: this.state.mobile,
  ...
  onFilterApply = () => {
    // if(this.state.clientData === null || this.state.clientData === undefined || this.state.clientData.length < 0){
    //   this.setState({
    //     clientData:
    //   })
    // }
      ...
      <React.Fragment>
        ...
        <div className="component-wrapper">
          <div className="listing-component-app">
            ...
            >
              {" "}
              <Link to="/adminDashboard">Dashboard</Link> / Client Contacts
            </div>
            <div
              ...
              <div className="table-responsive">
                <table width="100%" border="0" cellPadding="0" cellSpacing="0">
                  <tr>
                    ...
                    <th style={{ width: "10%" }}> No. of Jobs</th>
                              ...
                              >
                                <tr>
                                  ...
                                  >
                                    ...
                                    item.departmentName === ""
                                      ? "N/A"
                                      : item.departmentName.length > 15
                                      ? textTruncate(item.departmentName, 15)
                                      : item.departmentName}
                                  </td>
                    ...
                    <div class="row">
                      <div class="col-md-5">
                        <div class="sf-row">
                          ...
                          <div class="dropdwn client_drpdwn">
                            <Select
                              styles={customStyles}
