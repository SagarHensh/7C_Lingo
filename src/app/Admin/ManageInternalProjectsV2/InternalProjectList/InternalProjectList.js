...
import "./InternalProjectList.css";
import {
  InputText,
  MultiSelectBox,
  PaginationDropdown,
...
export default class InternalProjectList extends React.Component {
  constructor(props) {
    super(props);
  ...
  onClientChamge = (data) => {
    if (this.state.isAlljobs) {
      let fetchData = {
        ...
        searchto: "",
        scheduleDate:
          this.state.formDate == "" ? "" : SetDOBFormat(this.state.formDate),
        // scheduleTime: dt + ":00",
        scheduleTime: "",
        orderby: "",
        direc: "",
  ...
  goEdit = () => {
    consoleLog("sam");
    this.props.history.push({
      pathname: "/adminInternalProjectDetails",
  ...
  onTaskNotesChange = (e) => {
    this.setState({
      notesByAdmin: e.target.value,
    });
  };
  onAddNotesChange = (e) => {
    this.setState({
      addTaskNote: e.target.value,
    });
  };
  onTaskUpdate = () => {
    let objData = {
      ...
      notesByAdmin: this.state.notesByAdmin,
      addedNote: this.state.addTaskNote,
    };
  };
  ...
  onCreateProject = () => {
    return this.props.history.push("/adminCreateInternalProject")
  }
    ...
    return (
      <React.Fragment>
        ...
        <div className="component-wrapper vewaljobs">
          ...
          <div className="row create_project_sec">
                    ...
                    >
                      <tbody>
                        <tr>
                          ...
                          <th style={{ width: "15%" }}>Expected Deadline</th>
          ...
          <div className="modal-dialog modal-md modal-dialog-centered ">
            <div className="modal-content" style={{ width: "100%" }}>
              <div className="filter-head _fl mdfs taskHead">
                <div className="row">
                  <div className="col-md-12">
                    <h3 className="taskTitleHead">Task</h3>
                    <button className="task-close-page">
                      <img
                        style={{ width: "20px" }}
              ...
              <div className="modal-body">
                <div className="create-jeneral-wrap _fl">
                  <div className="row">
                    <div className="col-md-5">
                      <div className="form_rbx">
                        <span className="taskLabel">Task ID</span>
                        <p>123</p>
                      </div>
                    </div>
                    ...
                    <div className="col-md-5">
                      <div className="form_rbx">
                        <span className="taskLabel">Milestone</span>
                        <p>Internal Trainings</p>
                      </div>
                    </div>
                  </div>
                  <div className="row">
                  ...
                  <div className="row">
                    <div className="col-md-5">
                      <div className="form_rbx">
                        <span className="taskLabel">Task Description</span>
                        <p>Training 2</p>
                      </div>
                    </div>
                    <div className="col-md-2"></div>
                    <div className="col-md-5">
                      <div className="form_rbx">
                        <span className="taskLabel">Owner</span>
                        <p>Peter Paul</p>
                      </div>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-md-5">
                      <div className="form_rbx">
                        <span className="taskLabel">Start Date</span>
                        <p>Training 2</p>
                      </div>
                    </div>
                    <div className="col-md-2"></div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-5">
                      <div className="form_rbx">
                        <span className="taskLabel">Notes by Admin</span>
                        <textarea
                          rows="2"
                          placeholder=""
                          className="in-textarea msg min"
                          value={this.state.notesByAdmin}
                          style={{
                            height: "100px",
                            color: "var(--grey)",
                            borderRadius: "10px",
                  ...
                  <div className="row">
                    <div className="col-md-5">
                      <div className="form_rbx">
                        <span className="taskLabel">Add Notes</span>
                        <textarea
                          rows="2"
                          placeholder=""
                          className="in-textarea msg min"
                          value={this.state.addTaskNote}
                          style={{
                            height: "100px",
                            color: "var(--grey)",
                            borderRadius: "10px",
                          ...
                          onChange={this.onAddNotesChange}
                        ></textarea>
                      </div>
                    </div>
                  </div>
