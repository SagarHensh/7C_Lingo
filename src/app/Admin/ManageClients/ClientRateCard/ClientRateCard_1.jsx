...
export class ClientRateCard extends Component {
    constructor(props) {
        super(props);
        this.state = {
            showId: "",
    ...
    componentDidMount() {
        ...
        if (preData === undefined) {
            ...
            this.setState({
                ...
                clientName: preData.clientName
            });

            let data = {
                vendorId: preData.userId,
                serviceId: 45
            }
            ...
            <React.Fragment>
                ...
                <div className="component-wrapper" hidden={this.state.isLoad}>
                    ...
                    <div className="listing-component-app">
                        ...
                        >
                            {" "}
                            <Link to="/adminDashboard">Dashboard</Link> / <Link to="/adminClientList">Clients</Link> / Rate Card
                        </div>
                            <div className="vendor-info _fl sdw">
                                <div className="vn-form _fl">
                                    <div className="row">
                                        <div className="col-md-4">
                                            <div className="vn_frm" style={{ color: "grey", fontSize: "15px" }}>  Client : {this.state.clientName}
                                            </div>
                                        </div>
                                        <div className="col-md-4" />
                                        <div className="col-md-4 ">
                                                        ...
                                                        <td style={{ width: "6%", paddingLeft: "2%" }}>
                                                            <div className="row no-gutters" style={{ padding: "2%" }}>
                                                                <div className="col-md-12">
                                                                    ...
                                                                    /> */}
                                                                    {/* <a href='javascript:void(0)' onClick={() => this.openMileageModal(index)}>View</a> */}
                                                            ...
                                                            <div className="row no-gutters" style={{ padding: "2%" }}>
                                                                <div className="col-md-12">
                                                                    {/* <input
                                                                        ...
                                                                        onChange={(e) => this.handleMileageRate(e, index)}
                                                                    /> */}
                                                                    {/* <a href='javascript:void(0)' onClick={() => this.openMileageModal(index)}>
                                                                        View
                                                                    </a> */}
                                                                    <Button variant="text" onClick={() => this.openMileageModal(index)}>View</Button>
                                                                </div>
