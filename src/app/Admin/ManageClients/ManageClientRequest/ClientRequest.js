...
import { zipValidate } from "../../../../validators";
...
export default class ClientRequestList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoad: true,
  ...
  listApi = async (data) => {
    ...
    const res = await ApiCall("fetchclientReqlist", data);
    if (
  ...
  onNameChange = (value) => {
    ...
    let data = {
      ...
      this.state.toDate == undefined
        ? ""
        : SetScheduleDate(this.state.toDate),
    searchfrom:
      this.state.formDate == "" ||
      this.state.formDate == null ||
      this.state.formDate == undefined
        ? ""
        : SetScheduleDate(this.state.formDate),
    industryid:
  ...
  goEdit = () => {
    this.props.history.push({
      pathname: "/adminClientRequestEdit",
      state: this.state.listData[this.state.curIndex],
    });
  };
      ...
      <React.Fragment>
        ...
        <div className="component-wrapper">
          <div className="listing-component-app">
            ...
            >
              {" "}
              <Link to="/adminDashboard">Dashboard</Link> / Client Request
            </div>
            <div
                                ...
                                {item.businessemail}
                                  ...
                                  <td style={{ width: "5%" }}>
                                    ...
                                    >
                                      ...
                                      {/* <MenuItem onClick={this.declinerequest}>
                                        Cancel
                                      </MenuItem> */}
                                    </StyledMenu>
                                  </td>
