...
export default class ProjectList extends React.Component {
  ...
  listApi = async (data) => {
    ...
    const res = await ApiCall("getApprovedTranslation", data);
    if (
  ...
  historyApi = async (data) => {
    ...
    const resHistory = await ApiCall("getApprovedTranslationHistory", data);
    if (
    ...
    return (
      <React.Fragment>
        ...
        <div className="component-wrapper vewaljobs">
          ...
          >
            <Link to="/adminDashboard">Dashboard</Link> / Projects / Translation
          </div>
