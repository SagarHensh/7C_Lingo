...
export default class BidResponsePage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoad: true,
  ...
  onSubTitlingCostUnitChange = (e) => {
    let val = zipValidate(e.target.value);
    if (Regex.ONLY_15DIGITS_REGEX.test(+val)) {
      this.setState({
        subtitlingUnitCost: val,
      });
    }
  };
  onSubtitlingRateChange = (e) => {
    let val = zipValidate(e.target.value);
    if (Regex.ONLY_15DIGITS_REGEX.test(+val)) {
      this.setState({
        subtitlingRate: val,
        ...
        <div class="component-wrapper">
          <div class="create-offer sdw _fl">
            <div class="_fl create-offer-list">
              <h2>Bid Responses</h2>
              <p>
                <span>Project Id</span> 123456
              </p>
              <p>
                <span>Requested On</span> 20/05/2021
              </p>
            </div>
            ...
            <div class="tsk-col _fl m30 p-20 col-md-9">
            ...
            <div
              class="tsk-col _fl m30 p-20 col-md-2"
              style={{ paddingTop: "15px" }}
            >
              <a href="#" class="assign-btn" style={{ textDecoration: "none" }}>
                ASSIGN
              </a>
            </div>
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td style={{ textAlign: "center" }}>
                    <input
                      type="text"
                      value={this.state.subtitlingUnitCost}
                      name=""
                      placeholder="$000"
                      class="in-field4"
                      onChange={this.onSubTitlingCostUnitChange}
                    />
                  </td>
                  <td style={{ textAlign: "center" }}>
                    <input
                      type="text"
                      value={this.state.subtitlingRate}
                      name=""
                      placeholder="$000"
                      class="in-field4"
                      onChange={this.onSubtitlingRateChange}
                    />
                  </td>
                </tr>
            ...
            <div class="_button-style m30 _fl text-center">
              <a href="#" class="white-btn" style={{ textDecoration: "none" }}>
                back
              </a>
              <a href="#" class="blue-btn" style={{ textDecoration: "none" }}>
                submit
              </a>
            </div>
          </div>
