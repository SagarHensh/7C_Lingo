...
export default class Vendor_Request_contact extends Component {
  constructor(props) {
    super(props);
              ...
              <div className="row">
                ...
                <div className="col-md-2">
                  <div className="paginate">
                    ...
                    />
                    <button onClick={this.next} style={{ border: "none" }}>
                      {">"}
                    </button>
              ...
              <li>
                <div className="element">
                  ...
                  <div className="vendortableHead">
                    ...
                    <div style={{ marginLeft: "2px" }}>Agency</div>
                  </div>
                  <div className="vendortableHead">
                    <div className="btns">
                      <button className="arrowBtn">
                  ...
                  <div className="vendortableHead">
                    ...
                    <div style={{ marginLeft: "2px" }}>Services Offered</div>
                  </div>
                ...
                {this.state.listData.map((item, key) => (
                  <li key={key}>
                    <div className="elementBody ">
                      <div className="vendortableBody">{item.type}</div>
                      <div className="vendortableBody">{item.firstName}</div>
                      <div className="vendortableBody">{item.lastName}</div>
                      <div className="vendortableBody">{item.agency}</div>
                      <div className="vendortableBody">{item.email}</div>
                      <div className="vendortableBody">{item.phoneNo}</div>
                      <div className="vendortableBody">{item.service}</div>
                      {/* <div>John Doe</div> */}
                      <div className="vendortableBody">
                        <div
