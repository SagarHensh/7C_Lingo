...
import ViewServiceInfo from "./ViewServiceInfo";
...
export default class ViewRequest extends React.Component {
  ...
  componentDidMount() {
    ...
    if (preData.vendorid === undefined) {
      return history.push("/adminVendorList")
    } else {
      this.setState({
        showId: preData.vendorid
      })
    }
  ...
  getVendorInfo = async () => {
    ...
    this.getVendorProfileInfo(preData.vendorid);
    ...
    return (
      <React.Fragment>
        ...
        <div className="component-wrapper" hidden={this.state.isLoad}>
          ...
          >
            {" "}
            <Link to="/adminDashboard">Dashboard</Link> / <Link to="/adminVendorRegistration">Vendor Registration</Link> / Vendor Profile
          </div>
          ...
          <div className="myaccount-section-wrap _fl">
            <div className="row">
              <div className="col-md-9">
                ...
                <div className="my-form-rw _fl">
                  <h3>Service Info</h3>
                  <ViewServiceInfo vendorId={this.state.showId} />
                </div>
