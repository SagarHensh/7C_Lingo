...
export default class ServiceInfo extends React.Component {
                                ...
                                if (data.serviceId === parseInt(interpretorArr.id)) {
                                    if (data.info.length > 0) {
                                        if (data.info.length > 1) {
                                            document.getElementById("ser_otherLan_yes").checked = true;
                                            this.setState({
                                                isSelected: true
                                            });
                                            let arr = [];
                                            ...
                                            document.getElementById("ser_otherLan_no").checked = true;
                                            this.setState({
                                                isSelected : false
                                            })
                                        }
    ...
    onSelectYes = (e) => {
        // document.getElementById("ser_otherLan_yes").checked = true;
        // document.getElementById("ser_otherLan_no").checked = false;
        this.setState({
            isSelected: true,
        });
    };
    ...
    onSelectNo = (e) => {
        // document.getElementById("ser_otherLan_yes").checked = false;
        // document.getElementById("ser_otherLan_no").checked = true;
        this.setState({
            isSelected: false,
        });
