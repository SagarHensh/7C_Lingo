...
export default class EditClient extends Component {
  ...
  load = async () => {
    ...
    if (
      ...
      let payload = await Decoder.decode(clientInfoRes.data.payload);
      console.log("clientRepayloads::", payload);
      ...
      console.log("clientRes::", clientUserData);
      console.log("clientaddressRes::", clientBillAddressData);
      this.setState({
      ...
      if (
        ...
        this.setState({
          imagePath: IMAGE_STORE_PATH + clientUserData.companyLogo,
        });
      }
    }
  ...
  onBillingNext = async () => {
    ...
    if (errorCount === 0) {
      ...
      let data = {
        ...
        clientId: 1,
        clientid: preData.userId,
        primaryaddress: this.state.selectedLocation,
        ...
        billingaddress: this.state.billingSelectedLocation,
