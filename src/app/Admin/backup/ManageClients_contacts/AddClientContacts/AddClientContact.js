...
export default class AddClientContact extends Component {
  ...
  onNext = async () => {
    ...
    // );
    let validateLanguage = inputEmptyValidate(this.state.languageData.value);
    ...
    if (
      ...
      if (validateJobTitle === false) {
        ...
        errorCount++;
        console.log("jobtype::::", this.state.jobTypeData);
      }
  ...
  onAddressNext = async () => {
    ...
    if (errorCount === 0) {
      ...
      if (this.state.roleData.label === "Supervisor") {
        ...
        console.log("Requested data::::::", superData);
