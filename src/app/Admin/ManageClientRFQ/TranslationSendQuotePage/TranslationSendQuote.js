...
export default class TranslationSendQuote extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoad: true,
        ...
        <div className="component-wrapper" hidden={this.state.isLoad}>
          <div className="job-details-tab jobdltste _fl sdw">
            ...
            <div className="tab-content">
              ...
              <div className="tab-pane active" id="sendqute">
                <div className="job-section-tab">
                  ...
                  <div className="translation_table">
                    {this.state.taskDetails.map((item, key) => (
                      <div className="task_table">
                        <div class="tsk-col _fl m30 p-20">
                          <h3>
                            Task {key + 1} {item.serviceName}
                          </h3>
                          <ul>
                            <li
                              data-toggle="tooltip"
                        ...
                        <div class="tsk-tabl">
                          ...
                          >
                            ...
                            <tr>
                              <td style={{ textAlign: "left" }}>Fee</td>
