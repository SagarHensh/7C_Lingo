...
export default class ClientTranslationDetails extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoad: true,
            ...
            if (payload.data.services.length > 0) {
              payload.data.services.map(async (ser) => {
                if (
                  ...
                  consoleLog("Client Translation Details >", detailPayload);
                  ...
                  if (Object.keys(quoteInfo).length > 0) {
                    ...
                    let quoteData = JSON.parse(quoteInfo.additionalFee),
                      brr = quoteData.task;
                    // consoleLog("QuoteData::", quoteData)
  ...
  onOpenVendorListByTask = async (serviceId, sourceId, sourceLanguage, targetId, targetLanguage, taskId, taskNo, subTaskNo, serviceName) => {
    let reqObj = {
      requestId: this.state.requestId,
      serviceId: serviceId,
      ...
      <React.Fragment>
        ...
        <div className="component-wrapper" hidden={this.state.isLoad}>
          ...
          >
            ...
            <Link to="/clientTranslationList">Translation</Link>
          ...
          <div className="job-details-tab jobdltste _fl sdw bid_vend_assign_pge">
            ...
            <div className="tab-content">
              ...
              <div className="tab-pane " id="projectdetails">
                                        ...
                                        <tr>
                                          ...
                                          <td style={{ width: "5%" }}>
                                            <div className="web-form-bx">
                                              {data.bidCounter > 0 ?
                                                <>
                                                  <a href="javascript:void(0)" onClick={() => { this.onOpenVendorListByTask(data.serviceId, data.sourceLanguageId, data.sourceLanguage, data.targetLanguageId, data.targetLanguage, data.taskId, data.taskNo, data.subTaskNo, data.serviceName) }}>
                                                    <img
                                                      src={
                                                          ...
                                                          {sub.bidCounter > 0 ? <>
                                                            <a href="javascript:void(0)">
                                                              <img
                                                                ...
                                                                onClick={() => { this.onOpenVendorListByTask(sub.serviceId, sub.sourceLanguageId, sub.sourceLanguage, sub.targetLanguageId, sub.targetLanguage, sub.taskId, sub.taskNo, sub.subTaskNo, data.serviceName) }}
                                                              />
                      ...
                      <div className="table-responsive">
                        ...
                        >
                          ...
                          {this.state.allClientReviewDocs.length > 0 ? (
                            <React.Fragment>
                              {this.state.allClientReviewDocs.map((data, i) => (
