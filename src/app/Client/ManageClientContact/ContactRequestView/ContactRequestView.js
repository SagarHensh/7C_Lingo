...
export default class ClientViewContactRequest extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoad: true,
  ...
  load = async (id) => {
    ...
    if (
      ...
      this.setState({
        ...
        email: respObj.email,
        phone: "+" + respObj.countryCode + " " + respObj.mobile,
      ...
      <React.Fragment>
        ...
        >
          ...
          >
            ...
            <Link to="/clientContactRequestPage">Contacts Request</Link> /
            Contact Information
          </div>
