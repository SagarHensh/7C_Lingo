...
export default class EditClientContactPage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      page: true,
  ...
  load = async () => {
    ...
    let contactResData = await ApiCallClient(
    ...
    consoleLog("language array:::",languageResArrData)
    for (let n = 0; n < languageResArrData.length; n++) {
      ...
      if (
        clientContactInfo.prefLangId === null ||
        clientContactInfo.prefLangId === undefined ||
        clientContactInfo.prefLangId === ""
      ) {
    ...
    if (
      ...
      consoleLog("payload dept data::::::::::", payloadDept);
    ...
    consoleLog("other lang::id::", otherLangIdArr);
    ...
    this.setState({
      ...
      dobDate: SetUSAdateFormat(clientContactInfo.dob),
      ...
      specificDialectCode:
        clientContactInfo.specificDialectCode == "1" ? true : false,
      userId: clientContactInfo.userId,
      isSelected_language:
        clientContactInfo.proficiencyLanguage == 0 || clientContactInfo.proficiencyLanguage == null ? "false" : "true",
  ...
  onEmailChange = (e) => {
    //   consoleLog("email::",e.target.value)
    this.setState({
  ...
  onPhoneChange = (value) => {
    ...
    // let v = zipValidate(value);
    // consoleLog("phoneeee",v)
  ...
  //   }
    ...
    if (errorCount === 0) {
      ...
      if (this.state.roleData.label === "LEI") {
        ...
        let res = await ApiCallClient("updateClientContactDetailsClient", data);
          ...
          <React.Fragment>
            <div className="component-wrapper" hidden={this.state.isLoad}>
              ...
              >
                ...
                <Link to="/clientContactListPage">Client Contacts</Link> / Edit
              </div>
          ...
          <React.Fragment>
            <div className="component-wrapper" hidden={this.state.isLoad}>
              ...
              >
                ...
                <Link to="/adminClientContactList">Client Contacts</Link> / Edit
              </div>
              <div className="row">
                <div className="col-md-9">
                  <div className="department-component-app _fl sdw">
