...
import { getClientInfo, getLookUpDataFromAPI, phoneNumberCheck, SetDOBFormat } from "../../../services/common-function";
...
export default class TrainingModal extends React.Component {
    ...
    onLoad = async () => {
        ...
        let res = await ApiCallClient("getCourseWithCategoryForClientReq");
        if (
    ...
    onSubmit = async () => {
        ...
        if (errorCounter === 0) {
            ...
            // console.log("Final Submit data Training>>>>>", finalData);
            ...
            if (
                ...
                toast.success("Training Requested successfully");
