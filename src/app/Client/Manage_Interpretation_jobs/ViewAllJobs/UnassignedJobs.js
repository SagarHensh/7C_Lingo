...
import { PaginationDropdown, SelectBox, MultiSelectBox } from '../../../Admin/SharedComponents/inputText';
import Select, { components } from "react-select";
import { consoleLog, SetDateFormat, SetUSAdateFormat, SetDatabaseDateFormat } from '../../../../services/common-function';
...
export default class UnassignedJobs extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      curIndex: 0,
  ...
  goEditUnassign = () => {
    let value = this.props.unassignedData
    value.history.push({
