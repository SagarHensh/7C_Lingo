...
export default class AllJobs extends React.Component {
  ...
  load = async () => {
    ...
    // ...................requester,,,,,,,,,,,,,,,,,,
    let authData = Decoder.decode(localStorage.getItem("AuthToken"))

    // consoleLog("Auth::", authData)

    let requesterData = {
      clientid: authData.data.userid
    }
    ...
    if (
      ...
      let requestPayload = Decoder.decode(requesterRes.data.payload);
  ...
  listApi = async (data) => {
    ...
    if (
      ...
      consoleLog("Job List", decodeData.data);
      let listDetails = [];
  ...
  goEdit = (index) => {
    let value = this.props.allJobData;
  ...
  goToFollowUpPage = (data) => {
    // consoleLog("History Item", data)
    return history.push({
                  ...
                  <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tbody>
                      <tr>
                        ...
                        <th style={{ width: "6%" }}>No. of Interpreters</th>
                                        ...
                                        <td style={{ width: "4%" }}>
                                          <React.Fragment>
                                            ...
                                            >
                                              ...
                                              {/* <MenuItem onClick={() => this.goToFollowUpPage(item)}>Follow up</MenuItem> */}
                                              {/* <MenuItem
                                              onClick={() => this.goEdit()}
                                            >
                                              Connect
