...
export default class ApprovedContact extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isLoad: true,
    ...
    listApi = async (data) => {
        ...
        // console.log("api resp===>>",this.state.listData);
    };
    ...
    //   ..........add new button.......................
    addNew = () => {
        return history.push("/addNewClientContact");
    };
                                                    ...
                                                    >
                                                        <tr>
                                                            ...
                                                            {item.email.length > 20 ?
                                                                ...
                                                                <td style={{ width: "15%" }}>{textTruncate(item.email, 20)}</td>}
                                                            ...
                                                            <td style={{ width: "10%" }} >{SetDateFormat(item.createDate)} | {SetTimeFormat(item.createDate)}</td>
                                                            <td style={{ width: "8%" }}>
                                                                <FormControl
                                                                    component="fieldset"
                                                                    variant="standard"
                ...
                <div id="delete-model" className="modal fade modelwindow" role="dialog">
                    <div className="modal-dialog modal-lg">
                        ...
                        <div className="modal-content" style={{ padding: "10px" }}>
                            ...
                            <div className="modal-body">
                                <div className="body-txt">Are You Sure to delete the contact?</div>
