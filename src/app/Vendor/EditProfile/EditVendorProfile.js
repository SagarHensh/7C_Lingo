...
// import ServiceInfo from "../../Admin/Manage Vendors/EditVendorProfile/ServiceInfo";
import moment from "moment";
import { Link } from "react-router-dom";
import ProfileServiceInfo from "./ProfileServiceInfo";
...
export default class EditVendorProfile extends React.Component {
  ...
  componentDidMount() {
    ...
    preData = auth.data.userid;
    this.setState({
      showId: auth.data.userid,
    });
  ...
  getVendorInfo = async () => {
    ...
    this.getVendorProfileInfo(auth.data.userid);
    ...
    return (
      <React.Fragment>
        ...
        <div className="component-wrapper" hidden={this.state.isLoad}>
          ...
          >
            {" "}
            <Link to="/adminDashboard">Dashboard</Link> / Vendor Profile
          </div>
          ...
          <div className="myaccount-section-wrap _fl">
            <div className="row">
              <div className="col-md-9">
                ...
                <div className="my-form-rw _fl">
                  <h3>Service Info</h3>
                  <ProfileServiceInfo vendorId={this.state.showId} />
                </div>
