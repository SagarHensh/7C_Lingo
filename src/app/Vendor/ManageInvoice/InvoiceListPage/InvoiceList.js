...
export default class  InvoiceListVendor extends React.Component {
  constructor(props) {
    super(props);
    var today = new Date();
  ...
  getListDetails = async (data) => {
    // .............................................
    // consoleLog("dataaaaaaaaaaa:::::",data)
  

    let res = await ApiCallVendor("fetchVendorInvoice", data);
    // consoleLog("Res:", res);
    if (
      ...
      if(invoiceData == null || invoiceData == undefined || invoiceData == [] || invoiceData == {} || invoiceData == ""){
        this.setState({
          invoiceData:[]
        })
      } else {
    ...
    return (
      <React.Fragment>
        ...
        <div class="component-wrapper vewaljobs invoc_pge">
          ...
          >
            <Link to="/vendorDashboard">Dashboard</Link> / Invoices
          </div>
                        ...
                        {this.state.invoiceData.length > 0 ? <React.Fragment>
                            ...
                            <React.Fragment>
                              <tr>
                                ...
                                <td style={{ width: "10%" }}>{data.leiName == "" || data.leiName == undefined || data.leiName == null ? "N/A" : data.leiName}</td>
                                <td
                                  style={{ width: "10%" }}
                                  data-toggle="tooltip"
                                  data-placement="top"
                                  title={data.amount}
                                >
                                  <p style={{color:"#65A57C"}}>{data.amount}</p>
                                </td>
                                <td
                                  style={{ width: "10%" }}
